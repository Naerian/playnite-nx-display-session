...
- Permite elegir la **pantalla objetivo** de la sesión (flujos HTPC con TV).
- Posee el **HDR** con tres políticas globales, override por juego y coincidencia opcional por Features/Tags.
...
- Enlaza en suave con **Audio Switcher** si está instalado (solo reflexión; sin dependencia dura).
...
- La integración con Audio Switcher es best-effort si esa extensión está presente.
